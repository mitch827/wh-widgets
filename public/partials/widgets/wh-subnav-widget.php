 ...
 * @since 3.0.0
 */
 class WH_Footer_Sidenav_Menu_Widget extends WP_Widget {
	public function __construct() {
		$widget_ops = array( 'description' => __('Add a custom menu to the footer.') );
		parent::__construct( 'wh_footer_nav_menu', __('WH Footer Nav'), $widget_ops );
	}
	/**
	 * @param array $args
	...
	public function widget( $args, $instance ) {
		...
		$nav_menu_args = array(
			...
			'menu'        => $nav_menu,
			'container'		=> false,
			'items_wrap'    => '<ul class="%2$s side-nav">%3$s</ul>',
		);
		/**
